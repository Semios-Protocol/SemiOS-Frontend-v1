...
import ChartAssetPool from '../member/royalty/ChartAssetPool.vue'
import TableNftOwners from '../member/royalty/TableNftOwners.vue'
import ChartAssetPoolEth from '../member/royalty/ChartAssetPoolEth.vue'
import TransactionsTable from '../member/royalty/TransactionsTable.vue'
...
export default {
  ...
  props: {
    ...
    address: {
      type: String,
      default: '0xed66a255d1dd24a69010628bb30a01658c6ccafd',
    },
  },
  data() {
    return {
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      window.onresize = () => {
        this.$refs.chart_asset_pool
          ? this.$refs.chart_asset_pool.reResizeFn()
          : ''
        this.$refs.chart_asset_pool_eth
