...
<script>
import vueWaterfallEasy from "@/components/vue-waterfall/daoWaterFall";
import { myDaoList } from "@/common/api";
export default {
  components: {
    vueWaterfallEasy,
  },
  data() {
    return {
      noData: `Currently you don't have DAOs, you can launch your own DAO.`,
      isLoading: true,
      list: [],
      pageNo: 1,
      pageSize: 20,
  ...
  methods: {
    ...
    async getData() {
      ...
      const data = await myDaoList(query);
