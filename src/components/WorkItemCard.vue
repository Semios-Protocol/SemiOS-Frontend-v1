    ...
    <div class="daos-card">
      ...
      >
        <div class="item-title">
          <div class="title-left"><img :src="item.imgUrl" alt="" /></div>
          <div class="title-cen">
            ...
            <div class="item-price">
              ...
              >
                <span class="price-name"
                  >Minted Passes/Total Mintable Passes:</span
                >
            ...
            >
              <div class="infor-tab">
                ...
                <el-row class="row-item">
                  <el-col :span="8"
                    ><div class="card-name">Minters</div></el-col
                  >
                  <el-col :span="8"
                    ><div class="card-name">Mint Fee</div></el-col
                  >
                  <el-col :span="8"
...
export default {
  ...
  data() {
    return {
      ...
      tabName: 'currentMintWindowInformation',
    }
  },
  props: {
    list: {
