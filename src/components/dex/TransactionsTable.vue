    ...
    <div class="body-box" v-else>
      <div v-if="tableData && tableData.length > 0">
        ...
        >
            ...
            <template #header>
              <div>
                <span
                  class="item-tab"
                  @click="setTableTab(1)"
                  :style="{ color: tableTab === 1 ? '#B3B5F2' : '' }"
                  >Swaps</span
                >
                <span
                  class="item-tab item-center"
                  :style="{ color: tableTab === 2 ? '#B3B5F2' : '' }"
                  @click="setTableTab(2)"
                  >Adds</span
                >
                <span
                  class="item-tab"
                  :style="{ color: tableTab === 3 ? '#B3B5F2' : '' }"
                  @click="setTableTab(3)"
                  >Removes</span
                >
              </div>
          ...
          <el-table-column align="right" v-if="this.tableTab !== 1">
            <template #header>
          ...
          <el-table-column align="right" v-else>
            <template #header>
              <span class="table-title">
  ...
  methods: {
    ...
    async getData() {
      ...
      const query = {
        ...
        tradeType:
          this.tableTab === 1 ? [1, 2] : this.tableTab === 2 ? [3] : [4],
