  ...
  >
    ...
    >
      ...
      <div class="vue-waterfall" :style="{ height: colHeight + 'px' }">
        ...
        >
          <a :href="aPush(item)" style="text-decoration: none" v-if="!isDelete">
                ...
                <div class="item-nums">
                  <div class="nums-left">
                    ...
                    >
                      ...
                      />
                      <!-- <svg-icon
                        :icon-class="item.erc20PaymentMode ? 'tokenzi' : 'eth'"
                      /> -->
                    </span>
    ...
    <div v-if="imgsArr.length === 0 && !imgLoading" class="noList">
      No items to display
    </div>
    ...
    async setAmount(val, idx) {
      ...
      if (sig) {
        ...
        if (res) {
          ...
          this.$set(this.imgsArr_c, idx, item)
        }
      }
    },
    preload() {
      ...
      this.newImgsArr = this.newImgsArr.concat(newArr)
...
.reverse-spinner {
  ...
  border-top-color: #533fa1;
  border-left-color: #533fa1;
  border-radius: 50%;
...
.reverse-spinner::before {
  ...
  border-top-color: #62e6f8;
  border-left-color: #62e6f8;
  border-radius: 50%;
